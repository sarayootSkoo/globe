<script lang="ts">
  ...
  const shortcuts = [
    ...
    { keys: 'Q', desc: 'Brake' },
    { keys: '1 – 9', desc: 'Switch theme' },
    { keys: 'Space', desc: 'Toggle auto tour' },
    { keys: 'R', desc: 'Reset to defaults' },
    { keys: 'F', desc: 'Fullscreen / Immersive' },
    { keys: 'B', desc: 'Toggle border effect' },
    { keys: 'H', desc: 'Toggle black hole' },
